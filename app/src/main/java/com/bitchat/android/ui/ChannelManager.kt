...
class ChannelManager(
    ...
    fun joinChannel(channel: String, password: String? = null, myPeerID: String): Boolean {
        // Group channels (grp_xxx) use their raw ID; regular channels get # prefix
        val channelTag = if (channel.startsWith("#") || GroupManager.isGroupChannel(channel)) channel else "#$channel"
