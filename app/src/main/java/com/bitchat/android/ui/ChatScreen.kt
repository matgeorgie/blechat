...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val groupInfoSheetGroupId by viewModel.groupInfoSheetGroupId.collectAsStateWithLifecycle()
    val conversationSummarySheet by viewModel.conversationSummarySheet.collectAsStateWithLifecycle()
    ...
    ChatDialogs(
        ...
        groupInfoSheetGroupId = groupInfoSheetGroupId,
        onGroupInfoSheetDismiss = viewModel::hideGroupInfoSheet,
        conversationSummarySheet = conversationSummarySheet,
        onConversationSummaryDismiss = viewModel::hideConversationSummarySheet,
    )
}
        ...
        TopAppBar(
            title = {
                ChatHeaderContent(
                    ...
                    onShowSummary = viewModel::showCurrentConversationSummary
                )
            },
...
private fun ChatDialogs(
    ...
    groupInfoSheetGroupId: String?,
    onGroupInfoSheetDismiss: () -> Unit,
    conversationSummarySheet: com.bitchat.android.summary.ConversationSummarySheetData?,
    onConversationSummaryDismiss: () -> Unit,
) {
    val privateChatSheetPeer by viewModel.privateChatSheetPeer.collectAsStateWithLifecycle()
    ...
    if (groupInfoSheetGroupId != null) {
        GroupInfoSheet(
            isPresented = true,
            groupID = groupInfoSheetGroupId!!,
            viewModel = viewModel,
            onDismiss = onGroupInfoSheetDismiss
        )
    }

    if (conversationSummarySheet != null) {
        ConversationSummarySheet(
            data = conversationSummarySheet!!,
            onDismiss = onConversationSummaryDismiss
        )
    }
}
