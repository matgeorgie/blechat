...
class MessageManager(private val state: ChatState) {
    ...
    fun clearMessages() {
        ...
        try { com.bitchat.android.services.AppStateStore.clearPublicConversation() } catch (_: Exception) { }
    }
    ...
    fun clearChannelMessages(channel: String) {
        ...
        try { com.bitchat.android.services.AppStateStore.clearChannelConversation(channel) } catch (_: Exception) { }
    }
    ...
    fun clearPrivateMessages(peerID: String) {
        ...
        try { com.bitchat.android.services.AppStateStore.clearPrivateConversation(peerID) } catch (_: Exception) { }
    }
    ...
    fun updateMessageDeliveryStatus(messageID: String, status: DeliveryStatus) {
        ...
        if (updated) {
            ...
            try { com.bitchat.android.services.AppStateStore.updateMessageStatus(messageID, status) } catch (_: Exception) { }
        }
    ...
    fun removeMessageById(messageID: String) {
        ...
        try { com.bitchat.android.services.AppStateStore.removeMessageById(messageID) } catch (_: Exception) { }
    }
    ...
    fun clearAllMessages() {
        ...
        try { com.bitchat.android.services.AppStateStore.wipePersistentStore() } catch (_: Exception) { }
    }
}
